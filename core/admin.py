...
class GameAdmin(admin.ModelAdmin):
    list_display = ('name', 'standard_price', 'vip_price', 'created_at')
    search_fields = ('name',)

@admin.register(GameSession)
class GameSessionAdmin(admin.ModelAdmin):
    list_display = ('game', 'tariff', 'status', 'start_time', 'end_time', 'is_paid', 'created_by')
    list_filter = ('status', 'tariff', 'is_paid')
